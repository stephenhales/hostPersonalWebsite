...
Component.options.__file = "D:\\Projects\\PersonalWebsite\\app\\src\\scripts\\App.vue"
...
Component.options.__file = "D:\\Projects\\PersonalWebsite\\app\\src\\scripts\\components\\NavComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "D:\\Projects\\PersonalWebsite\\app\\src\\scripts\\components\\FooterComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("StephenHales ")])], 1), _vm._v(" "), _c('li', [_c('router-link', {
    staticClass: "navLink",
    attrs: {
      "active-class": "active",
      "to": "/",
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Source code")]), _vm._v(". Made by Stephen Hales")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
...
function viewProject (name) {
  return function (resolve) {
    __webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(34)("./Project" + name + '.vue')]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
  }
}
